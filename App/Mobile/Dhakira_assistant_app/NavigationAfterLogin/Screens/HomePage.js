...
function HomePage()
{
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <TouchableOpacity style={{width: '80%', height:69, backgroundColor:'#4EA8DE', borderRadius:21, marginBottom:50, justifyContent: 'center', alignItems: 'center'}}><Image style={{width:60, height:53.82,position:'absolute',left:10,top:8}} source={require('../../Images/2.png')}/><Text style={{fontSize:24, fontWeight:'bold', color:'white'}}>Discussion</Text></TouchableOpacity>
