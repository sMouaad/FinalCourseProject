                ...
                <div className="flex justify-between items-center text-base gap-8">
                    ...
                    <ul className="lg:flex space-x-12 hidden items-center">
                        {navItems.map(({ link, path }) => (
                            <li key={path}>
                                <a href={`#${path}`} className="block cursor-pointer lg:flex items-center text-base text-white hover:text-white first:font-medium">
                                    {link}
                                </a>
                            </li>
                        ))}
        ...
        <div id="about">
            <div className="mx-auto flex flex-row md:flex-row justify-between items-center gap-12">
                <div className="md:w-3/5 mx-auto px-10">
                    <h2 className="text-4xl text-[#00E5BD] drop-shadow-lg font-bold mb-4">gratuit. efficace.</h2>
                    <h2 className="text-4xl text-[#00E5BD] drop-shadow-lg font-bold mb-4">efficace.</h2> 
                    <p>lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem</p>
                </div>
                <div>
                    <img src="/src/assets/dhakira-laptop.png" alt="" className="w-100 object-right"/>
                </div>
    ...
    return (
        <div id="app">
            <div className="md:w-3/5 px-10 flex-col">
                <h2 className="text-4xl text-[#00E5BD] drop-shadow-lg font-bold mb-4">CONNECT,</h2>
                <h2 className="text-4xl text-[#00E5BD] drop-shadow-lg font-bold mb-4">ASSIST,</h2>
                <h2 className="text-4xl text-[#00E5BD] drop-shadow-lg font-bold mb-4">REMEMBER.</h2>
                <p className="font-bold">Improving Social Skills Together: Your Trusted Dhakira !</p>
            </div>
            <div className="flex">
                <div className="md:w-3/5 p-10 flex-col">
                    <img src="/src/assets/qrcode.png" alt="" className="w-60"/>
                    <p className="text-wrap w-40 py-4">Scannez le code pour telecherger l’app sur votre telephone</p>
                </div>
                <div className="flex">
                   <img src="/src/assets/dhakira-mobile.png" alt=""  className="w-80 absolute z-10 right-20"/> 
